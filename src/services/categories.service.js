...
const listCategories = async () => {
  ...
  return categories.map((c) => ({ id: c._id, name: c.name, icon_url: c.icon_url }));
};
...
const createCategory = async ({ name, icon_url }) => {
  ...
  return { id: category._id, name: category.name, icon_url: category.icon_url };
};

const updateCategory = async (id, { name, icon_url }) => {
  ...
  return { id: updated._id, name: updated.name, icon_url: updated.icon_url };
};
